...
with right:
    if not submitted and "last_result" not in st.session_state:
        ...
        sheet_start("C · Determination", meta=f"{file_no} · {name.upper()}")
        ...
        sheet_start("D · Safety checks", meta="EITHER FIRES → HUMAN")
        c1, c2 = st.columns(2)
        with c1:
        ...
        with rc1:
            ...
            sheet_end()
        with rc2:
            sheet_start("F · Comparable past files", meta="C2 SCORE = AVG DISTANCE OF THESE")
